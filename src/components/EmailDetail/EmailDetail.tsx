        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex items-center justify-between mb-8 pb-8 border-b border-slate-800/50">
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="flex items-center gap-2">
                  <span className="font-semibold text-slate-200">{selectedEmail.sender_name}</span>
                  <span className="text-sm text-slate-500">&lt;{selectedEmail.sender_addr}&gt;</span>
                </div>
            ...
            <div className="flex items-center gap-2">
              <button 
                onClick={handleStar}
                className="p-2 text-slate-400 hover:text-yellow-500 hover:bg-yellow-500/10 rounded-lg transition-colors"
              >
